				...
				<>
					...
					<DialogDescription className='mb-12'>
						...
						<p className='text-muted mb-6'>
							Dear customer, the data shows a comprehensive description of the stock that o a certain company which you
							have searched for. We ensure to make available the volume of stock traded, also the highest and lowest
							traded, this is to ensure transparency to the public{' '}
						</p>
